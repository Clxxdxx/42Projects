...
/*   Updated: 2025/04/29 11:29:42 by clalopez         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	load_images(t_game *game)
{
	...
	game->img_wall = mlx_xpm_file_to_image(game->mlx, "imgs/wall.xpm", &w, &h);
	game->img_player = mlx_xpm_file_to_image(game->mlx, "imgs/player.xpm", &w,
			&h);
	game->img_exit = mlx_xpm_file_to_image(game->mlx, "imgs/exit.xpm", &w, &h);
